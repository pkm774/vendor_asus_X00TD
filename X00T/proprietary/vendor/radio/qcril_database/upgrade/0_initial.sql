...
CREATE TABLE IF NOT EXISTS qcril_emergency_source_escv_iin_table(IIN TEXT, NUMBER TEXT, ESCV INTEGER, ROAM TEXT, PRIMARY KEY(IIN,NUMBER,ROAM));
...
INSERT INTO "qcril_emergency_source_escv_nw_table" VALUES('262','03','110',1);
